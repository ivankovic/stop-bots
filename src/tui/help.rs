...
pub fn render(frame: &mut Frame, area: Rect) {
    let lines = vec![
        ...
        Line::from("  Tab, Shift+Tab     switch screen (also: Left/Right, h/l)"),
        ...
        Line::from("  Tab, Shift+Tab     switch between the SSH and User Agent panels (not screens, here)"),
        Line::from("  Enter              block the selected PENDING row, or unblock a BLOCKED one"),
        Line::from("  f                  cycle the display filter: all / pending only / blocked only"),
        Line::from(""),
        Line::from("Global"),
